...
const PointsStructure = () => {
  ...
  const fetchPointsStructure = async () => {
    try {
      ...
      setFormData({
        spend_amount: data.spend_amount.toString(),
        points_awarded: data.points_awarded.toString()
      });
    } catch (error) {
                ...
                <>
                  ...
                  >
                    ...
                    <Typography variant="body1">
                      for every ${currentStructure.spend_amount.toFixed(2)} spent
                    </Typography>
                  </Box>
                  
                  <Alert severity="info" sx={{ mb: 2 }}>
                    Last updated: {new Date(currentStructure.updated_at).toLocaleString()}
                  </Alert>
